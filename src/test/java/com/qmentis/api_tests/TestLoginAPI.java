...
public class TestLoginAPI extends BaseRestAssuredTest {
    ...
    /**
     * Sets up the RestAssured request specification before any test methods run.
     */
    @BeforeClass
    public void setUp() {
    ...
    public Object[][] loginTestDataProvider() {
        return new Object[][] {
            {"Valid credentials", "testuser@example.com", "ValidPass123!", 200, true},
    ...
    /**
     * Tests login scenarios using data from the data provider.
     *
